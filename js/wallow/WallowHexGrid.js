...
const hexGridShapes = {
    '-1': {'-1': [e6], 0: [f4, f8, a3], 1: [f4, f8, a3], 2: [f4, f8, a3], 3: [f4, f8, a3], 4: [f4, f8, a3],
     ...
     10: [x1, x0, y1, y0, z0, b3, b5, b7, b9, c0], 11: [x1, x0, y1, y0, z0, z4, z5, z6, z7, b5, b7], 12: [yy3, xx9, y5, x6, z0], 13: [xx3, zz5, xx9, zz11, v1], 14: [zz1, yy3, zz7, yy9, v5], 15: [zz5, xx9, v1]},

    0: {'-1': [], 0: [sc1, sc3, sc5, sc7, sc9, sc11], 1: [sc4, sc8, sc12], 2: [f4, f8, f12, rc2, rc6, rc10], 3: [f4, f8, f12, a2, a6, a10, b55, a54, a58, a512, a555], 4: [f1, f3, f5, f7, f9, f11, a2, a6, a10, b55, a54, a58, a512],
     ...
     10: [x1, x0, y1, y0, z1, z0, b1, b3, b5, b7, b9, b11, c0], 11: [x1, x0, y1, y0, z1, z0, z4, z5, z6, z7, b1, b5, b7, b11], 12: [x1, y6, x5, y1, x0, y5, x6, y0, z1, z5, z6, z0], 13: [x1, x2, x9, x0, y1, y3, y8, y0, v3], 14: [xx1, yy5, xx7, yy11, v3], 15: [x1, x0, y1, y0, z1, z0, v0], 16: [xx1, yy5, xx7, yy11, v3]},
    ...
    1: {/**/'-1': [], 0: [sb1, sb3, sb5, sb7, sb9, sb11], 1: [sb4, sb8, sb12], 2: [f4, f8, f12, l2, l6, l10], 3: [f4, f8, f12, a2, a6, a10, b55, a54, a58, a512], 4: [wa4, wa8, wa12, b55, a54, a58, a512],
         ...
         10: [z1, z2, z3, x8, x9, x0, y8, y9, y0, c0], 11: [x1, x2, y3, y1, x0, x9, y8, y0, z4, z5, z6, z7], 12: [x1, x0, y1, y0, z4, z5, z6, z7, i6, i12], 13: [x1, x0, y1, y0, i6, i12, v3], 14: [xx3, zz5, xx9, zz11, v1], 15: [zz1, yy3, zz7, yy9, v5]},

    2: {'-1': [], 0: [tb2, tb4, tb6, tb8, tb10, tb12, c0], 1: [sa1, sa3, sa5, sa7, sa9, sa11], 2: [sa4, sa8, sa12], 3: [f4, f8, f12, ra2, ra6, ra10], 4: [f4, f8, f12, a2, a6, a10, a5],
     ...
     10: [g12, g4, g8, x4, y4, z7], 11: [z1, z2, z3, x8, y4, x4, y9, z7, x0, x9, y8, y0], 12: [z1, z2, z3, x8, y4, x4, y9, x0, y5, x6, y0, z0], 13: [x1, x0, y1, y0, z5, z6, c6, c12], 14: [x0, y5, x6, y0, z1, z0, uu1, uu2, uu3, uu4], 15: [x8, x0, z0, y9, y0, g12, u5, u6], 16: []},

    3: {/**/'-1': [], 0: [ta0, ta1, ta3, ta5, ta7, ta9, ta11], 1: [w1, w3, w5, w7, w9, w11], 2: [qa1, qa3, qa5, qa7, qa9, qa11, qa0, qa2, qa6, qa10], 3: [qb1, qb3, qb5, qb7, qb9, qb11, qb0, qb2, qb6, qb10], 4: [qc1, qc3, qc5, qc7, qc9, qc11, qc0, qc2, qc6, qc10],
         ...
         10: [g12, g4, g8, z4, x7, y7], 11: [z1, z2, z3, z4, x8, x7, y7, y9, x0, x9, y8, y0], 12: [v4x, v8x, v12, x0, x9, y8, y0, z1], 13: [v4, v8, v12, x0, y0, z1], 14: [u4, u8, u12, x1, x0, y1, y0, z1, z0], 15: [u4, u8, u12, x1, x0, y1, y0, z1, z0]},

    4: {0: [e2, e6, e10, ea2, ea6, ea10], 1: [w1, w3, e6, e10, ea6, ea10], 2: [w1, w3, e6, ea6, w9, w11], 3: [f1, f3, f5, f7, f9, f11, l2, l6, l10], 4: [f1, f3, f5, f7, f9, f11, a3],
    ...
    5: {/**/0: [e2, ea2, e6, ea6, w9, w11], 1: [f4, fa4, w7, w9, w11, w1], 2: [f4, fa4, f8, fa8, w11, w1], 3: [f4, f8, f1, f11, ah3, ah9], 4: [f4, f8, f12, a3],
    ...
    6: {0: [cz0], 1: [e2, ea2, w5, w7, e10, ea10], 2: [f4, fa4, w7, w9, f12, fa12], 3: [f4, fa4, f8, fa8, f12, fa12], 4: [f4, f8, f12, a3h1, a3h7],
...
const hexGridOffsets = {
    '-1': {'-1': '15,-5', 0: '15,-5', 1: '10,-4', 2: '8,-4', 3: '6,-4', 4: '3,-4', 5: '1,-3', 6: '-1,-3', 7: '-1,-1', 8: '-1,-1', 9: '-2,0', 10: '-1,0', 11: '2,0', 12: '5,0', 13: '9,2', 14: '15,3', 15: '19,4'},

    0: {'-1': '15,-5', 0: '15,-5', 1: '10,-4', 2: '8,-4', 3: '6,-4', 4: '3,-4', 5: '1,-3', 6: '-1,-3', 7: '-1,-1', 8: '-1,-1', 9: '-2,0', 10: '-1,0', 11: '2,0', 12: '5,0', 13: '9,2', 14: '15,3', 15: '19,4', 16: '19,4'},

    1: {/**/'-1': '12,-5', 0: '12,-5', 1: '8,-4', 2: '6,-5', 3: '3,-4', 4: '1,-4', 5: '-0.5,-4', 6: '-2,-2', 7: '-3,-1', 8: '-4,0', 9: '-3,0', 10: '0,1', 11: '2,4', 12: '6,8', 13: '9,9', 14: '14,10', 15: '14,10'},

    2: {'-1': '13,-8', 0: '13,-8', 1: '11,-8', 2: '7,-7', 3: '5,-6', 4: '3,-6', 5: '1,-5', 6: '0,-3', 7: '-2,-2', 8: '-4,0', 9: '-3,1', 10: '-1,2', 11: '0,5', 12: '3,7', 13: '7,9', 14: '11,10', 15: '16,11', 16: '16,11'},

    3: {/**/'-1': '12,-11', 0: '12,-11', 1: '9,-10', 2: '6,-9', 3: '3,-8', 4: '1,-7', 5: '0,-4', 6: '-1,-3', 7: '-4,-2', 8: '-3,0', 9: '-2,2', 10: '0,4', 11: '2,5', 12: '5,8', 13: '9,10', 14: '14,12', 15: '14,12'},

    4: {0: '10,-15', 1: '9,-13', 2: '7,-12', 3: '5,-10', 4: '1,-8', 5: '0,-7', 6: '-2,-6', 7: '-3,-4', 8: '-4,-2', 9: '-3,0', 10: '-3,4', 11: '-1,4', 12: '2,7', 13: '6,9', 14: '9,12', 15: '14,15'},

    5: {/**/0: '10,-14', 1: '9,-12', 2: '6,-12', 3: '4,-11', 4: '1,-9', 5: '0,-6', 6: '-1,-5', 7: '-5,-3', 8: '-4,-1', 9: '-4,1', 10: '-3,4', 11: '-1,7', 12: '2,10', 13: '6,13', 14: '10,15'},

    6: {0: '10,-15', 1: '9,-15', 2: '6,-15', 3: '4,-15', 4: '1,-13', 5: '0,-11', 6: '-3,-9', 7: '-3,-6', 8: '-5,-3', 9: '-6,0', 10: '-5,3', 11: '-2,6', 12: '-1,9', 13: '1,11', 14: '6,14', 15: '9,18'},
};
