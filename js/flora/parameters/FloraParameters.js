...
class FloraParameters extends PieceParameters {
    ...
    _declareParameters() {
        return {
            ...
            ...P.NumColumns({start: 17, max: 17}),
            ...P.NumRows({start: 5, max: 8}),
            ...P.CustomToggle({name: 'oscillate', button: 1}),
            ...P.CustomToggle({name: 'showCenters', button: 4, start: true}),
            ...P.CustomToggle({name: 'showEdges', button: 5, start: false}),
            latency: {
