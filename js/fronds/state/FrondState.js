    ...
    _declareParameters() {
        return {
            ...
            angle: {
                ...
                constrainTo: false,
                listenToWheel: MixtrackWheels.R_TURNTABLE,
            },
            scaleLog2: {
                type: MovingLinearParameter,
                range: [-4, 5],
            ...
            autorotatePeriodLog2: {
                ...
                start: 3,
                listenToDecrementAndIncrementButtons: [MixtrackButtons.R_LOOP_MANUAL, MixtrackButtons.R_LOOP_IN],
                variance: 0.1,
            ...
            autoscalePeriodLog2: {
                ...
                range: [0, AUTOPILOT_FREQ_MAX],
                start: 2,
                listenToDecrementAndIncrementButtons: [MixtrackButtons.R_LOOP_OUT, MixtrackButtons.R_LOOP_RELOOP],
                variance: 0.1,
                autoupdateEveryNBeats: 16,
            },
            numLeaves: {
                ...
                range: [2, 32],
                start: 2,
                listenToWheel: MixtrackWheels.R_SELECT,
                variance: 1.5,
            ...
            leafLengthLog2: {
                ...
                start: 0,
                incrementAmount: 0.25,
                listenToWheel: MixtrackWheels.R_CONTROL_1,
            ...
            leafTapering: {
                ...
                start: 1,
                incrementAmount: 0.1,
                listenToDecrementAndIncrementButtons: [MixtrackButtons.R_DELETE, MixtrackButtons.R_HOT_CUE_1],
            ...
            leafPointLength: {
                ...
                range: [0, 1],
                start: 0.5,
                listenToKnob: MixtrackKnobs.R_TREBLE,
